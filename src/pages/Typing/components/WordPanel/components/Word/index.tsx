...
import IconFire from '~icons/fa-solid/fire'
  ...
  return (
    <>
      ...
      <div
        ...
        className={`flex flex-col items-center justify-center pb-1 pt-4 ${isDyslexiaModeEnabled ? 'font-opendyslexic' : ''}`}
      >
        ...
        >
          ...
          >
            {word.isIrregular && <IconFire className="mr-2 text-orange-500" />}
